...
const Dashboard = () => {
  ...
  // Remove o useEffect que estava causando loop infinito
  useEffect(() => {
  ...
  const exportToExcel = () => {
    try {
      // Criar dados para exportação baseados nos counters atuais
      const exportData = [
        {
          Métrica: "Em Atendimento",
          Valor: counters.inAttendanceCount || 0,
        },
        {
          Métrica: "Aguardando",
          Valor: counters.waitingTickets || 0,
        },
        {
          Métrica: "Finalizados",
          Valor: counters.finishedTicketsCount || 0,
        },
        {
          Métrica: "Grupos",
          Valor: counters.groupsCount || 0,
        },
        {
          Métrica: "Atendentes Ativos",
          Valor: `${counters.attendantsOnline || 0}/${
            counters.attendantsTotal || 0
          }`,
        },
        {
          Métrica: "Novos Contatos",
          Valor: counters.newContactsCount || 0,
        },
        {
          Métrica: "Mensagens Recebidas",
          Valor: counters.receivedMessages || 0,
        },
        {
          Métrica: "Mensagens Enviadas",
          Valor: counters.sentMessages || 0,
        },
        {
          Métrica: "Tempo Médio de Atendimento",
          Valor: counters.avgAttendanceTime || "00h 00m",
        },
        {
          Métrica: "Tempo Médio de Espera",
          Valor: counters.avgWaitTime || "00h 00m",
        },
        {
          Métrica: "Tickets Ativos",
          Valor: counters.activeTickets || 0,
        },
        {
          Métrica: "Tickets Passivos",
          Valor: counters.inactiveTickets || 0,
        },
      ];
      ...
      // Adicionar informações do período do relatório
      const reportInfo = [
        ["Relatório Dashboard"],
      ...
      const wsInfo = XLSX.utils.aoa_to_sheet(
        reportInfo.concat([
          ["Métrica", "Valor"],
          ...exportData.map((item) => [item.Métrica, item.Valor]),
        ])
      );

      const wb2 = XLSX.utils.book_new();
      XLSX.utils.book_append_sheet(wb2, wsInfo, "RelatorioCompleto");

      // Exportar arquivo
      XLSX.writeFile(wb2, `dashboard-${moment().format("YYYY-MM-DD")}.xlsx`);
            ...
            <Grid container spacing={2} alignItems="center">
              <Grid item xs={12} sm={6} md={3}>
                ...
                >
                  ...
                  <option value={2}>Por Atendente</option>
                ...
                <CardContent>
                  ...
                  <ChartDonut
                    data={[
                      {
                        name: "Em Atendimento",
                        value: counters.inAttendanceCount || 0,
                        color: "#01a19a",
                      },
                      {
                        name: "Aguardando",
                        value: counters.waitingTickets || 0,
                        color: "#ff9800",
                      },
                      {
                        name: "Finalizados",
                        value: counters.finishedTicketsCount || 0,
                        color: "#4caf50",
                      },
                    ]}
                    title="Atendimentos"
